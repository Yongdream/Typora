...
![img](D:\Yang7hi\note\typora_photo\C++\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQwNzY1NTM3,size_16,color_FFFFFF,t_70.png)
...
![C++内存分区](D:\Yang7hi\note\typora_photo\C++\image-20240711162436798.png)
...
- **三个迭代器**
  ...
  - **`end:`**指向的是vector中所占内存空间的末尾字节位置
    ![C++vector容器-构造函数_c++ vector动态扩容 构造函数-CSDN博客](D:\Yang7hi\note\typora_photo\C++\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L20wXzUxOTU1NDcw,size_16,color_FFFFFF,t_70#pic_center.png)
...
<img src="D:\Yang7hi\note\typora_photo\C++\58eff65eeb8dd7687924494a74d00f4c.png" style="zoom:50%;" />

<img src="D:\Yang7hi\note\typora_photo\C++\2-19121316430U40.gif" alt="img" style="zoom:50%;" />
...
<img src="D:\Yang7hi\note\typora_photo\C++\b03be4eacc15474a9d995d37c5381a22.png" alt="img" style="zoom: 50%;" />

<img src="D:\Yang7hi\note\typora_photo\C++\6bbbe7faf59740b99ecc987932d892b6.png" alt="img" style="zoom:50%;" />
...
- **增删改查时间复杂度不同**
  ...
  查改：数组支持随机访问O(1),链表支持顺序访问O(n)

  增删：数组需要移动改动后续的O(n),链表O(1)
