...
本人杨志，25届杭州电子科技大学硕士研究生，就读于浙江省装备电子重点实验室。我对技术有着强烈的探索欲望，追求知其然更知其所以然。在校期间，参与了包括国家自然科学基金项目在内的多个科研项目，具备良好的团队沟通、学习能力和抗压能力。研究生期间，以第一作者身份在顶级期刊发表了一篇论文。

在研究生期间，我开发了多个项目，其中包括：
...
2. **WebServer项目**：这是一个轻量级服务器项目，采用主从 Reactor 加线程池的网络模型，支持 HTTP 和 FTP 协议处理，并提供轻量化存储引擎。在云端部署后，通过压力测试，2 核 CPU 环境下的 QPS 达到 30 万以上。
...
我的兴趣爱好广泛，钟爱摄影和篮球，既追求学术上的创新，也享受生活中的美好时刻。
